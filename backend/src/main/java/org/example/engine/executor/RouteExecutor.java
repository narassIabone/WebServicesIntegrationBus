...
public class RouteExecutor {
    ...
    public void execute(@Payload Message message,
        ...
        try {
            ...
            sendAudit(traceId, message, currentNode, route.getId(), route.getName(), payloadBefore, duration, "SUCCESS", null);
            ...
            long duration = System.currentTimeMillis() - startTime;
            handleProcessingError(message, currentNode, currentTopic, e, traceId, payloadBefore, duration, route.getId(), route.getName());
        }
    }

    private void handleProcessingError(Message message, NodeConfig currentNode, String currentTopic,
                                       Exception e, UUID traceId, String payloadBefore, long duration, UUID routeId, String routeName) {
    ...
    private void sendAudit(UUID traceId, Message message, NodeConfig node, UUID routeId, String routeName,
        ...
        auditService.logStep(AuditData.builder()
                ...
                .nodeConfig(new HashMap<>(node.getConfig()))
                .duration(duration)
                .errorMessage(error)
                .build());
    }
